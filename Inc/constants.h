...
#define DIST_PER_REVOLUTION 206.5//214.635// 210.481 //304.734 // Distance traveled for a full wheel revolution (in mm)
#define TICKS_PER_DEG 91.108345 // 91.001144 // 91.055 	// 89.28//89//89.06 //4.86          // Nb of diff tick (enc1 - enc2) it takes to rotate 1 deg (old value: 4.7)
